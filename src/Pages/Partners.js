                  ...
                  <div className="sm:flex">
                    <div className="hidden sm:flex items-center sm:divide-x sm:divide-gray-100 mb-3 sm:mb-0">
                      <form className="lg:pr-3">
                        ...
                        <div className="mt-1 relative lg:w-64 xl:w-96">
                          <input onChange={(e) => {setSearchTerm(e.target.value)}} type="text" name="searchTerm" id="partners-search" className="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Search for partners"/>
                        </div>
                      </form>
                    ...
                    <div className="flex items-center space-x-2 sm:space-x-3 ml-auto">
                      ...
                      <Dialog open={openAddPartnerDialog} onClose={handleClose}>
                        {editable ? (<EditPartner partnerId={partnerId}/>) : (<NewPartner/>)}
                      </Dialog>
                          ...
                          {userPartners.filter((userPartner) => {
                            ...
                            <tr className="hover:bg-gray-100" key={userPartner.user_id}>
                              ...
                              <td className="p-4 whitespace-nowrap space-x-2">
                                ...
                                <button type="button" data-modal-toggle="delete-partner-modal" className="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-sm inline-flex items-center px-3 py-2 text-center">
                                  <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
                                    <path fillRule="evenodd" d="M9 2a1 1 0 00-.894.553L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2V6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1 0 00-1-1z" clipRule="evenodd"/>
                                  </svg>
                                </button>
